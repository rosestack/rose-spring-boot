package io.github.rosestack.spring.boot.autoconfigure;
...
import static io.github.rosestack.processor.configuration.ConfigurationProperty.APPLICATION_SOURCE;
import static io.github.rosestack.util.ArrayUtils.combine;
 ...
 * <pre>{@code
 * rose.autoconfigure.exclude=com.example.FooAutoConfiguration,com.example.BarAutoConfiguration
 * }</pre>
 *
