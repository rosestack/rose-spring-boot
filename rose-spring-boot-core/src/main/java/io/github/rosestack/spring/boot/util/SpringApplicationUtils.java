package io.github.rosestack.spring.boot.util;

import io.github.rosestack.annotation.Nullable;
import io.github.rosestack.util.ArrayUtils;
import io.github.rosestack.util.ShutdownHookUtils;
...
import static io.github.rosestack.spring.boot.constants.PropertyConstants.DEFAULT_MICROSPHERE_SPRING_BOOT_LOGGING_LEVEL;
import static io.github.rosestack.spring.boot.constants.PropertyConstants.MICROSPHERE_SPRING_BOOT_LOGGING_LEVEL_PROPERTY_NAME;
...
public abstract class SpringApplicationUtils {
    ...
    static {
        ShutdownHookUtils.addShutdownHookCallback(defaultPropertiesResources::clear);
    }
    ...
    public static void log(SpringApplication springApplication, String[] args, @Nullable ConfigurableApplicationContext context,
        ...
        Object[] arguments = ArrayUtils.ofArray(springApplication.getMainApplicationClass(),
